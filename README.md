...
#### Access Control
In many application scenarios, such as those in enterprises or organizations, users’ access to data is usually selective and highly differentiated. Different users have different access privileges regarding the data. When data are outsourced to the cloud, enforcing secure, efficient, and reliable data access among a large number of users is thus critical. 
